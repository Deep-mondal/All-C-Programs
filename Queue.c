...
#define size 10
int a[size],f,r;
void dequeue()//deleting an element from front side
{
    if(f==-1)
    {
...
void enqueue( )// inserting an element in rear side
{
    int x;
    if(r==size-1)
    {
...
void display()//display the array
{
 ...
 int main()
 {
   ...
   switch(n)
       ...
       case 4: exit(0);
       break;
       default: printf("\nInvalid entry! please put a valid choice");
       }
   }
       return 0;
 }
